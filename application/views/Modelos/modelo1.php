<ul class="uk-breadcrumb" style="padding:  0px 70px 0px 70px">
    ...
    <li><a href="<?php echo base_url();?>Informacion/Arduino">Luz Intermitente</a></li>
     <li><a href="<?php echo base_url();?>Modelos/Arduino">Modelo Luz Intermitente</a></li>
</ul>

	   	<center><div id="render"></div></center>
	    <script type="text/javascript" src="<?php echo base_url('assets/js/Modelos/APractica1.js')?>">
	    </script>		
