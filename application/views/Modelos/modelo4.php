<ul class="uk-breadcrumb" style="padding:  0px 70px 0px 70px">
    ...
    <li><a href="<?php echo base_url();?>Modelos/APractica4">Modelo de Entrada Analógica</a></li>
</ul>	 

	   	<center><div id="render"></div></center>
	    <script type="text/javascript" src="<?php echo base_url('assets/js/Modelos/APractica4.js')?>">
	    </script>		
